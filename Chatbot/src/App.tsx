...
function App() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      let judgmentMessageId: number | null = null;
          ...
          if (line.startsWith('data: ')) {
            ...
            try {
              ...
              if (data.content) {
                ...
                // Handle judgments as separate message
                if (data.type === 'judgments' && !judgmentMessageId) {
                  judgmentMessageId = Date.now() + 1;
                  setMessages(prev => [
                    ...prev,
                    {
                      id: judgmentMessageId,
                      text: data.content,
                      isBot: true,
                      section: currentSection,
                      type: 'judgments'
